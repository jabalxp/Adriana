    ...
    <div class="dashboard-layout">
        ...
        <main class="main-content">
            ...
            <div class="page-header" style="margin-bottom: 2rem;">
                <h2 style="font-size: 1.8rem; font-weight: 700; color: #1e293b;">Calendário Acadêmico</h2>
                <p style="color: #64748b;">Cronograma de atividades e prazos.</p>
            </div>

            <div class="content-card" style="text-align: center; padding: 5rem;">
                <i class="fa-solid fa-calendar-check" style="font-size: 5rem; color: #cbd5e1; margin-bottom: 2rem;"></i>
                <h3 style="color: #64748b;">Calendário em desenvolvimento</h3>
                <p style="color: #94a3b8;">Em breve você poderá visualizar todos os prazos aqui.</p>
            </div>
        </main>
    </div>
</body>
